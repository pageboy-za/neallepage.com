    ...
    <div className="flex flex-auto flex-row">
      <div className="h-1/2 min-h-full">
        <div className="pt-16 px-4 pb-4">
          <span className="block w-screen font-sans text-8xl md:text-9xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-blue-400 mb-10 p-4 text-shadow" >Nealle Page</span>
        </div>

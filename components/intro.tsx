    ...
    <section className="flex flex-col ">
      <div className="w-full bg-gold-200 rounded-lg max-w-screen-2xl py-2 mb-1 border-8 border-white shadow-sm">
          ...
          <div className="flex justify-start">
            <Link href="/">
                <h1 className="text-7xl md:text-8xl font-bold tracking-tighter leading-tight mx-6 mb-8 text-black">
                    Nealle Page
                </h1>
            </Link>
          </div>
        ...
        <div className='mt-8 px-4 flex flex-col'>
            <h3 className="text-gray-700 text-center md:text-left text-xl text-semibold mt-5 md:pl-8 prose prose-headings">
            A technology product manager delivering products to B2B clients and consumers around the world.
            </h3>
            <h4 className='text-center md:text-left text-lg px-4 md:px-8 text-black'>
